...
func CreateTask(ctx context.Context, c *app.RequestContext) {
	...
	resp, err := service.NewCreateTaskService(ctx, c).Run(&req)
	if err != nil {
		utils.SendErrResponse(ctx, c, consts.StatusOK, err)
		return
	}
...
func QueryTask(ctx context.Context, c *app.RequestContext) {
	...
	resp, err := service.NewQueryTaskService(ctx, c).Run(&req)
	if err != nil {
		utils.SendErrResponse(ctx, c, consts.StatusOK, err)
		return
	}
...
func DeleteTask(ctx context.Context, c *app.RequestContext) {
	...
	resp, err := service.NewDeleteTaskService(ctx, c).Run(&req)
	if err != nil {
		utils.SendErrResponse(ctx, c, consts.StatusOK, err)
		return
	}
...
func UpdateTask(ctx context.Context, c *app.RequestContext) {
	...
	resp, err := service.NewUpdateTaskService(ctx, c).Run(&req)
	if err != nil {
		utils.SendErrResponse(ctx, c, consts.StatusOK, err)
		return
	}
