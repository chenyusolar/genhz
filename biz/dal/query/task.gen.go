...
func newTask(db *gorm.DB, opts ...gen.DOOption) task {
	...
	_task.Userid = field.NewInt64(tableName, "userid")
	_task.Adress = field.NewString(tableName, "adress")
	_task.Token = field.NewString(tableName, "token")
	_task.Recipients = field.NewString(tableName, "recipients")
	_task.Amounts = field.NewString(tableName, "amounts")
...
type task struct {
	...
	Adress     field.String // wallet address
	Token      field.String // Token
	Recipients field.String // recipients list
	Amounts    field.String // amounts list
	Status     field.Int32  // Task status
	CreatedAt  field.Time   // task create time
	UpdatedAt  field.Time   // task update time
	DeletedAt  field.Field  // task delete time
...
func (t *task) updateTableName(table string) *task {
	...
	t.Adress = field.NewString(table, "adress")
	t.Token = field.NewString(table, "token")
	t.Recipients = field.NewString(table, "recipients")
	t.Amounts = field.NewString(table, "amounts")
...
func (t *task) fillFieldMap() {
	...
	t.fieldMap["adress"] = t.Adress
	t.fieldMap["token"] = t.Token
	t.fieldMap["recipients"] = t.Recipients
	t.fieldMap["amounts"] = t.Amounts
