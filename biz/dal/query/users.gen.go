...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Private = field.NewString(tableName, "private")
...
type user struct {
	...
	ALL       field.Asterisk
	ID        field.Int64  // PK
	UserName  field.String // User name
	Email     field.String // User email
	Password  field.String // User password
	Address   field.String // User wallet address
	Private   field.String // User wallet private key
